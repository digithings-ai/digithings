"""Paging on the shallow recall path: ``digisearch_web_search`` (#4234).
...
an explicit empty page past the query's result count, and a default call that
stays byte-identical to the unpaged output.
"""
