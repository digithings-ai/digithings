"""Contract tests for migration 086, outcome horizon + natural unique (#2797)."""
...
MIGRATION_PATH = MIGRATIONS_DIR / "086_olympus_forecast_outcome_horizon_unique.sql"
...
def test_migration_is_the_only_086() -> None:
    assert sorted(MIGRATIONS_DIR.glob("086_*.sql")) == [MIGRATION_PATH]
