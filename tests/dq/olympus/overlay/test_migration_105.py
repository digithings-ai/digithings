...
WRITERS = (
    ...
    "scripts/atlas/publish_document.py",
    "scripts/atlas/publish_research.py",
    "scripts/atlas/materialize_snapshot.py",
    "scripts/atlas/backfill_normalize_schemas.py",
    "scripts/atlas/backfill_pm_rebalance_and_activity.py",
)
