...
WP8.5 (#2738): cadence/turnover composition with the post-cutover sizing shell is locked
...
def test_incumbent_turnover_preference_defaults_frozen() -> None:
    """WP6.1 (#2687): document turnover/cadence defaults exercised by sizing backstop."""
