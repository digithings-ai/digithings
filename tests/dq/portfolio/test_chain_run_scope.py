...
def test_fanout_ticker_reads_back_the_send_cursor() -> None:
    ...
    from digiquant.olympus.hermes.focus_roster import fanout_ticker, with_fanout_ticker
...
def test_h5_and_h6_fanouts_declare_the_telemetry_discriminator() -> None:
    ...
    from digiquant.olympus.hermes.focus_roster import fanout_ticker
    from digiquant.olympus.hermes.phases import h5_asset_analyst, h6_deliberation
