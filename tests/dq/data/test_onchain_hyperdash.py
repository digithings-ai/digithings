...
class TestHyperdashScraper:
    ...
    def test_off_keeps_scraper_off(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_empty_canonical_keeps_off(self, monkeypatch: pytest.MonkeyPatch) -> None:
        # A present-but-empty canonical must keep the switch off (#3778).
