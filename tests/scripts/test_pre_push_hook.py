"""Pytest entry for tests/scripts/test_pre_push_hook.sh (#2468 / #2463).

The shell suite is the source of truth (stdin-protocol cases against
...
@pytest.mark.unit
def test_pre_push_hook_deletion_taxonomy_suite() -> None:
