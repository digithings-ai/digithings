...
| `digivault/mcp_server.py` | `python -m digivault.mcp_server` — thin transport wrapper; tools register exclusively via `tool_dispatch.register_mcp_tools` (streamable HTTP, default `127.0.0.1:8769`). |
