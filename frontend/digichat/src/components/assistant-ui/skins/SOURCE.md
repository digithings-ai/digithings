# Official assistant-ui templates (11)

Ids match assistant-ui `list_templates`. Client containers pick one with
...
- import paths rewritten into this tree / vanilla stock markdown + tool fallback
