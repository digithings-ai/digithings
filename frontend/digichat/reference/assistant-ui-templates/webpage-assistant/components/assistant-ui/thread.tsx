...
export const Thread: FC<ThreadProps> = ({
  welcomeHeadline = "Hello there!",
  welcomeBody = "How can I help you today?",
      ...
      >
        <div className="mx-auto flex min-h-full w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
          <AuiIf condition={(s) => s.thread.isEmpty}>
            <ThreadWelcome headline={welcomeHeadline} body={welcomeBody} />
          </AuiIf>
...
const ThreadWelcome: FC<{ headline: string; body: string }> = ({ headline, body }) => {
  return (
    <div className="aui-thread-welcome-root flex min-h-0 grow flex-col justify-end pt-4">
      <div className="aui-thread-welcome-center flex w-full flex-1 flex-col justify-end">
        <div className="aui-thread-welcome-message flex flex-col px-2 pb-4">
  ...
  return (
    <div className="aui-thread-welcome-suggestion-display fade-in slide-in-from-bottom-2 animate-in fill-mode-both duration-200 nth-[n+3]:hidden @md:nth-[n+3]:block">
      <SuggestionPrimitive.Trigger send asChild>
        <Button
          variant="ghost"
          className="aui-thread-welcome-suggestion border-primary/25 bg-primary/5 hover:bg-primary/10 hover:border-primary/50 h-auto w-full flex-wrap items-start justify-start gap-1 rounded-3xl border px-4 py-3 text-start text-sm transition-colors @md:flex-col"
        >
