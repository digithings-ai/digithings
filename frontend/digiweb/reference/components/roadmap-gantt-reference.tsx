...
const ROWS: Initiative[] = [
  { label: "research loop", livery: "research", start: 1, end: 3 },
  { label: "Kelly-capped sizing", livery: "digiquant", start: 2, end: 4 },
  { label: "Live broker adapters", livery: "portfolio", start: 3, end: 6 },
  { label: "dashboard", livery: "execution", start: 5, end: 8 },
