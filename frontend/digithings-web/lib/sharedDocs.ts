...
export const guides: Guide[] = [
  {
    ...
    blocks: [
      { kind: "p", text: "digithings is open-source, MIT-licensed AI infrastructure: ten modules that plug into the stack you already run rather than replacing it. digigraph orchestrates the three specialist sub-graphs — quant research, retrieval, and chat. Self-hosted anywhere, BYOK, audit-on by default." },
