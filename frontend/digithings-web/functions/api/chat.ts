...
//
// Transitional (#2068): restored after promote #2053 / cutover #2013 left
// digithings.ai/chat unconfigured (no Tunnel / NEXT_PUBLIC_DIGICHAT_EMBED_ORIGIN).
// Prefer digichat → digigraph via /embed once ops sets the Pages embed origin;
// this OpenRouter digivault loop remains the fallback for builds without it.
