...
export default function DivergenceChip({ gap, onClick, className }: DivergenceChipProps) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center rounded border border-warn/40 bg-warn/10 px-1.5 py-0.5 text-[10px] font-mono text-warn transition-colors hover:border-warn/60 hover:bg-warn/15${
        className ? ` ${className}` : ''
      }`}
