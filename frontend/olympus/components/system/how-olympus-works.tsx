...
import { Layers, Clock, Zap, Bot, Database, Globe } from 'lucide-react';
...
/**
 * "How Olympus works" — the pipeline explainer. Extracted from the former
 * `/architecture` page so it can live as a section of the demoted System
 * surface (its title is an h2; the System page owns the page h1).
 */
export function HowOlympusWorks() {
  return (
    <div className="space-y-8">
      ...
      {/* Pipeline flow */}
      <div className="glass-card p-6">
        <h3 className="font-display text-xl font-normal mb-3">Pipeline flow</h3>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-xl font-normal">Cadence &amp; control</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="glass-card p-5 border-t-2 border-fin-blue/40">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-bold">Daily run</h4>
          ...
          <div className="glass-card p-5 border-t-2 border-fin-green/40">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-bold">Refresh scope</h4>
          ...
          <div className="glass-card p-5 border-t-2 border-fin-amber/40">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-bold">Operator controls</h4>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-xl font-normal">Atlas — research graph</h3>
        </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-xl font-normal">Hermes — portfolio graph</h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="glass-card p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-display text-lg font-normal">Web grounding</h3>
          </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-display text-lg font-normal">Model routing</h3>
          </div>
          <p className="text-sm text-text-secondary leading-relaxed">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display text-xl font-normal">What a run persists</h3>
        </div>
        <div className="glass-card p-0 overflow-hidden">
          <div className="overflow-x-auto">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          <Bot size={16} className="text-fin-green" />
          <h3 className="font-display text-xl font-normal">Phase map</h3>
        </div>
