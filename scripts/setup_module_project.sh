...
add_field "Phase" \
  "Phase 2 — Hardening,Phase 3 — Domain unification,Phase 4 — research on digigraph,Phase 5 — research tiering,Client Pilot"
add_field "Area" \
  "Cross-cutting,digigraph,digiquant,digisearch,digismith,digikey,digichat,digibase,digiclaw,Website,Client Pilot,Docs,research"
add_field "Kind" \
