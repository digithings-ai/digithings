...
VALID_PHASES="Phase 2 — Hardening|Phase 3 — Domain unification|Client Pilot|Phase 4 — research on digigraph|Phase 5 — research tiering"
VALID_AREAS="Cross-cutting|digigraph|digiquant|digisearch|digismith|digikey|digichat|digibase|digiclaw|Website|Client Pilot|Docs|research"
