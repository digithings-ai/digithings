...
ALLOWLIST = {
    ...
    # (migrate-vs-leave: canvas art stays concrete). digiquant's three canvas
    # files were deleted in #4430 (the hero is the kit ProductFrame artefact
    # now), so their sanctions went with them.
