...
def _publish_json(out, summary: dict):
    """Emit the unified TearsheetData JSON the React renderer consumes.
...
def _manifest_entry(data) -> dict:
    """Compact summary card for the strategy-library index (the React route)."""
    return {
        ...
        "href": f"/strategies/{data.strategy}",
    }
