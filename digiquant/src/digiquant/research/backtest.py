...
from cloudflare/dashboard/lib/portfolio-risk-metrics.ts, max-drawdown + information ratio from
cloudflare/dashboard/components/portfolio/advanced-stats-panel.tsx (ported to Python; the pandas
