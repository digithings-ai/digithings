...
from apps/dashboard/lib/portfolio-risk-metrics.ts, max-drawdown + information ratio from
apps/dashboard/components/portfolio/advanced-stats-panel.tsx (ported to Python; the pandas
