...
Used by ``digiquant.atlas.triage`` to convert raw per-ticker percentage
moves (computed in :func:`digiquant.atlas.supabase_io.query_price_deltas`)
...
def max_abs_move_for_segment(
    ...
    :func:`digiquant.atlas.supabase_io.query_price_deltas` — values are
