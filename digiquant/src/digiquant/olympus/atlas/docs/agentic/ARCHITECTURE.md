...
6b. **Ticker evidence bundles (#2844 / WP11.1)** — typed H5
   ...
   one base and one request. No H6 selection cutover yet (WP11.3+); no public
   view; not yet an operator-durable publish path (WP11.2).
