...
Public surface:
    - :class:`digiquant.portfolio.state.HermesState` — sub-graph state model.
    - :func:`digiquant.portfolio.graph.build_hermes_graph` — Hermes phases as
...
Transitional state in #472 (the package skeleton ticket):
    Atlas's :func:`digiquant.research.graph.build_atlas_graph` still wires the
