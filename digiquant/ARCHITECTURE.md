...
**Research-state store (#2854 / WP12.2, hardened #2867).** Private append-only tables in
  ...
  **Ticker evidence bundles (#2844 / WP11.1).** Immutable H5 base
  ...
  conventions — does not invent a parallel hash scheme. Does **not** cut over
  H6 selection (WP11.3+); durable SQL IO is required before WP11 can close;
  in-memory typed bundles remain valid in shadow if the writer is disabled.
