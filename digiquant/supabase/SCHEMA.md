...
- **Exception — `olympus_run_events` (migration 066, #1945; WP1 join 084 / #2763):** ordered
  ...
  credentials, or reasoning. Migration 084 makes private token/cost columns nullable so missing
  usage stays NULL. Migrations 066/084 are not applied live without the repository's human
