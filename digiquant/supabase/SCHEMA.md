...
- **Exception — `olympus_run_events` (migration 066, #1945; WP1 join 085 / #2763):** ordered
  ...
  credentials, or reasoning. Migration 085 makes private token/cost columns nullable so missing
  usage stays NULL. Migrations 066/085 are not applied live without the repository's human
