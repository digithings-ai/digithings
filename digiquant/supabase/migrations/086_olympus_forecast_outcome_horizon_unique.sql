-- 086_olympus_forecast_outcome_horizon_unique.sql
--
...
-- No historical fabrication of horizon values (NULL allowed for pre-086 rows;
...
COMMENT ON COLUMN public.olympus_forecast_outcomes.horizon_sessions IS
    ...
    'Used to filter calibration cohorts; NULL only for pre-086 rows.';
