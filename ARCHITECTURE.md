...
| **digiquant** | `python -m digiquant.mcp_server` | 8767 (streamable-http) or stdio | `run_pipeline`, `list_strategies`, `run_backtest`, `run_optimize`, `run_validation` | digigraph (invokes via HTTP orchestrator), power-user IDE |
