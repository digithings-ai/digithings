...
// @digithings/ui (main barrel). Mock the barrel, preserving the real exports
// the rest of this view's tree relies on (Button, gloomberbTickerUrl, …).
vi.mock('@digithings/ui', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@digithings/ui')>();
  return {
    ...actual,
