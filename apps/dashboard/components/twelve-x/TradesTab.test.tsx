...
describe('TradesTab', () => {
  ...
  it('exposes Impact slider and board date range trigger (not binary chip / select)', () => {
    ...
    // K1: the Impact threshold is the kit's Base UI Slider
    // (`@digithings/ui/ui`). The part carries data-slot="slider" and composes
    // its track/range/thumb slots, so the semantic pins hold under the kit.
