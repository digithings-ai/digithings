...
import { Sheet, SheetContent, SheetTitle } from '@digithings/ui/ui';
 ...
 * @digithings/ui Sheet, whose portal never renders under static SSR, so the
 ...
 * source link.
 *
 * Chrome is the shared @digithings/ui Sheet (#1450): Base UI's Dialog supplies
