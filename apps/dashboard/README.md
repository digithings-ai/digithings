...
@import "@digithings/ui/styles/web-theme.css";        /* THE @theme inline bridge (#1402) */
@import "@digithings/design/quant-native/styles.css";
@import "@digithings/ui/styles/finance-tearsheet.css"; /* print-grade .ts-* family (#1463) */
```
...
leaderboard (`@digithings/ui` finance-composites) cannot host their row
...
**CSP (REM-077):** security headers ship from `apps/digiquant-web/public/_headers`,
...
digichat — see `apps/digichat/.env.example`.
...
npm --workspace apps/dashboard run test    # Vitest (lib/**/*.test.ts + components/**/*.test.tsx)
```
...
(`@digithings/ui/styles/web-theme.css`) over the canon tokens
...
[`../../packages/ui/MIGRATION.md`](../../packages/ui/MIGRATION.md) for
