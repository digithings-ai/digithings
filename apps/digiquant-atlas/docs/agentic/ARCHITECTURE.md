...
**Goal:** the Atlas frontend (Next.js dashboard at `apps/digiquant-atlas/frontend/`) and any other consumer can fetch a daily run's full state with one query and zero pipeline-runtime imports. Issue [#302](https://github.com/digithings-ai/digithings/issues/302).
