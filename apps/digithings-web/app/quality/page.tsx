...
const LIMITS: { term: string; body: string }[] = [
  ...
  },
  {
    ...
    body:
      "The score job only reads Python diffs, so the rubrics never see JS or CSS — rightly, " +
      ...
      "The two exceptions are digiquant-web and the design reference: both ship test scripts no lane invokes (test-web.yml lints them only), " +
      "so the pipeline-data pin and the reference route smoke test are a local discipline — a narrower net, honestly narrower.",
  },
  {
