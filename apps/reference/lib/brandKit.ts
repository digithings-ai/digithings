 ...
 *
 *  Served copies live under apps/reference/public/brand/ and are
 *  kept in sync by `packages/brand/build-header.py --check`. Canonical
 *  sources stay in `packages/brand/` so a second hand-copied logo
