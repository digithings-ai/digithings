...
import { Emblem, modules } from "@digithings/ui";
  ...
  return (
    <section className={`section-block feature-picker accent-${current.id}`}>
      ...
      >
        ...
        <span className="absolute end-[1rem] top-[1rem] rounded-none border border-hair px-[0.5rem] py-[0.15rem] font-mono text-[0.58rem] uppercase tracking-[0.08em] text-ink-mute">
