import { ModuleCard, moduleById, type ModuleNode } from "@digithings/ui";

/**
 * Module card — the landing-page module tile from @digithings/ui, the sibling
  ...
  return (
    <section className="section-block">
      ...
      <p className="section-copy">
        <code>ModuleCard</code> from <code>@digithings/ui</code> is the landing-page module tile —
