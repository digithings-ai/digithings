...
import { NavShell, GitHubGlyph, type NavLink } from "@digithings/ui";
...
/**
 * Nav shell — the production top-bar primitive from @digithings/ui, framed as
  ...
  return (
    <section className="section-block">
      ...
      <p className="section-copy">
        <code>NavShell</code> from <code>@digithings/ui</code> supersedes the per-app nav copies:
