 ...
 * `@digithings/ui` (components/conviction) and consumed live below.
 *
 ...
 */
import { ConvictionMeter, SignedConvictionBadge } from "@digithings/ui";
  ...
  return (
    <section className="section-block" id="conviction">
      ...
      <p className="section-copy">
        ...
        promoted to <code>@digithings/ui</code> and consumed live below. Three distinct
