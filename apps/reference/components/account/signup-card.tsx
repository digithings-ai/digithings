...
import { Button, Checkbox, Input, Label, Separator } from "@digithings/ui/ui";
 ...
 * `@digithings/ui/ui`; the terms row pairs a Label with a Checkbox (the
 ...
 * (`@digithings/ui/ui`, Base UI), not the controls layer.
 */
