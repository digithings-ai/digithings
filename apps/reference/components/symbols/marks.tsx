/**
 * Product brand marks — promoted to @digithings/ui (#1548,
 * components/symbols/marks.tsx), which is now the canonical copy of the
 * four-stroke digiquant signature (previously quadruplicated across the
 ...
 */
import { DigiquantMark as SharedDigiquantMark, Wordmark as SharedWordmark } from "@digithings/ui";
