  ...
  return (
    <div className="phone" role="img" aria-label="digiquant mobile app mockup">
      ...
      <div className="phone-screen">
        ...
        <div className="dq-status" aria-hidden="true">
          <span>9:41</span>
          <span className="dq-status-r">
            <i />
            <i />
            <i />
          </span>
        ...
        <header className="dq-head">
          <span className="dq-brand">
            <DigiquantMark size={18} />
            digiquant
          </span>
          <span className="dq-live">
        ...
        <div className="dq-hero">
          <span className="dq-hero-label">portfolio</span>
          <span className="dq-hero-value">$1.284M</span>
          <span className="dq-hero-delta up">+$5.47K · +0.43% today</span>
        </div>

        <div className="dq-chart" aria-hidden="true">
        ...
        <p className="dq-section">signals</p>
        <ul className="dq-list">
          {SIGNALS.map((s) => (
            <li key={`${s.scope}-${s.name}`} className="dq-row">
              <span className="dq-scope">{s.scope}</span>
              <span className="dq-name">{s.name}</span>
              <span className={`dq-pct ${s.up ? "up" : "down"}`}>{s.pct}</span>
            </li>
          ))}
        </ul>

        <nav className="dq-tabs" aria-hidden="true">
          {[
            ...
            <span key={d} className={`dq-tab${i === 0 ? " on" : ""}`}>
