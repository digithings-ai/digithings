 ...
 *  PricingMatrix from @digithings/ui (the primitive owns the toggle state;
...
import { PricingMatrix, type PricingMatrixGroup, type PricingMatrixTier } from "@digithings/ui";
