...
import { CommandPalette, type CommandPaletteGroup } from "@digithings/ui";
 ...
 * Consumes the shared <CommandPalette/> shell from @digithings/ui — the shell
...
const COMMAND_GROUPS: { label: string; commands: Command[] }[] = [
  ...
  },
  {
    label: "Navigate",
    commands: [
      { id: "desk", label: "Open dashboard", hint: "O", livery: "digiquant" },
