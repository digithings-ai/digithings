 ...
 *
 * PROMOTED to `@digithings/ui`; consume it from there. The implementation and
 * the full docblock live in `web/src/components/terminal/TerminalStepCaret.tsx`,
 * and the `.tl-*` styles in `@digithings/ui/styles/terminal-loaders.css`. This
 ...
 */
export { TerminalStepCaret, type TerminalStepCaretProps } from "@digithings/ui";
