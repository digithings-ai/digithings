...
(`apps/digichat-cloudflare/src/paths.ts:22`) and redeploy when a rotation
...
On the **digichat** Worker (`apps/digichat-cloudflare`):
...
- digichat Container: [`apps/digichat-cloudflare/README.md`](../digichat-cloudflare/README.md)
