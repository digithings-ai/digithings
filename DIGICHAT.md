...
The marketing site (**`website/`**, GitHub Pages) links to **DigiChat** at **`https://chat.digithings.ai`** (nav + same URL for production). There is no chat app under `website/` — only the Next.js app in **`digichat/`**.
