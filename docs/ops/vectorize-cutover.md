...
- **Name: must equal `DIGISEARCH_INDEX` / the `DIGI_TENANT_CORPUS_MAP` entry**
  ...
  [`apps/digithings-stack-cloudflare/wrangler.toml`](../../apps/digithings-stack-cloudflare/wrangler.toml).
  ...
  **Verified 2026-08-11:** Cloudflare's docs give **advisory** naming guidance
  ...
  `apps/digithings-stack-cloudflare/container/seed_chroma.sh`.
