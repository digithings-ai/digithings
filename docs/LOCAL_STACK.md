...
| **A′ — Profile A bundle** | `make digichat-profile-a-bundle-up` | Inside one stack image `:8005` | Website digichat / CF parity — one supervisord container instead of N services. See [`apps/digithings-stack-cloudflare/README.md`](../apps/digithings-stack-cloudflare/README.md). |
