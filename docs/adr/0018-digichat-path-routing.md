...
- **Preferred digichat host:** Cloudflare Containers (Workers Paid) — [`cloudflare/digichat-cloudflare/`](../../cloudflare/digichat-cloudflare/README.md).
- **Preferred backends:** Cloudflare Containers Profile A stack — [`cloudflare/digithings-stack-cloudflare/`](../../cloudflare/digithings-stack-cloudflare/README.md). Production must **not** depend on Mac Docker or `*.trycloudflare.com` quick tunnels.
...
4. 2026-08-06: `cloudflare/digichat-cloudflare/` Containers scaffold deleted (#1949).
...
- Profile A stack Container: see [`cloudflare/digithings-stack-cloudflare/`](../../cloudflare/digithings-stack-cloudflare/README.md).
