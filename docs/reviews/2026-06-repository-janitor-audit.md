...
|---------|------|--------------|-------|
| `packages/design/` | npm workspace `@digithings/design` | Imported by digichat, olympus, static sites | **Keep** |
...
| `apps/digichat/` | Next.js 16 BFF + chat | Compose profile `digichat` | **Keep** |
...
| **JAN-031** | Keep | `packages/design` + static landings | — | — |
