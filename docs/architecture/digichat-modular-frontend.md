...
**Related:** [ADR-0018](../adr/0018-digichat-path-routing.md), [ADR-0028](../adr/0028-digichat-web-foundation-and-opencode-distribution.md), [product / renderer contract](digichat-renderer-contract.md), [`apps/digichat/ARCHITECTURE.md`](../../apps/digichat/ARCHITECTURE.md)
...
```text
apps/digichat/src/lib/adapters/
  digithings/
    stream.ts
