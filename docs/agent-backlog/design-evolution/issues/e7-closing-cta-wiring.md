...
Wire **`ClosingCtaBand`** (E2) on both **digithings.ai** and **digiquant.io** — final conversion section before footer with literal CTAs ([COPY_GUIDE.md §6–10](../../../../packages/design/COPY_GUIDE.md)).

## Component

- [x] `apps/digithings-web/`, `apps/digiquant-web/`
...
- [ ] `packages/design/EVOLUTION.md` — note Phase E wiring
