...
| Product rebrand (retire olympus / atlas / hermes / kairos) | in_progress | [ADR-0026](../adr/0026-retire-olympus-atlas-hermes-kairos.md) | [Scope](../plans/2026-08-30-product-rebrand-scope.md) — product is digiquant; wave 1 copy + wave 2 `/dashboard/` path (308s from `/olympus/`). Python packages, SQL tables, and `frontend/olympus` folder stay until later hops. |
