...
| Product rebrand (retire olympus / atlas / hermes / kairos) | in_progress | [ADR-0026](../adr/0026-retire-olympus-atlas-hermes-kairos.md) | [Scope](../plans/2026-08-30-product-rebrand-scope.md) — product is digiquant; wave 1 is user-facing copy (landing, dashboard chrome, vision, design specimens). `/olympus/` path, Python packages, and tables stay until later waves. |
