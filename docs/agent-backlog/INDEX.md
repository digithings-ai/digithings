...
| Olympus Kairos + tenancy | blocked | [kairos-tenancy/](kairos-tenancy/README.md) · [HUMAN-UNBLOCK](kairos-tenancy/HUMAN-UNBLOCK.md) | All 12 WPs on `develop`; staging E2E still exit 2 (Stripe/Mailgun/Alpaca captchas). House documents upsert hotfix [#3278](https://github.com/digithings-ai/digithings/pull/3278) on `main`. Overlay private books blocked until P6 drops 097 `UNIQUE(date)`. Do not merge draft [#3183](https://github.com/digithings-ai/digithings/pull/3183)/[#3256](https://github.com/digithings-ai/digithings/pull/3256); never apply cutover 900. |
