...
| Product rebrand (retire olympus / atlas / hermes / kairos) | in_progress | [ADR-0026](../adr/0026-retire-olympus-atlas-hermes-kairos.md) | [Scope](../plans/2026-08-30-product-rebrand-scope.md) — product is digiquant; `/dashboard/` is canonical (308s from `/olympus/`). Python packages, SQL tables, and `frontend/olympus` folder stay until later hops. |
