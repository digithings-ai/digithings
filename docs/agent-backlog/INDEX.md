...
| Olympus Kairos + tenancy | todo | _(file epic per spec §10)_ | [Implementation spec](../superpowers/specs/2026-08-29-kairos-tenancy-implementation-spec.md) (decisions locked, per-WP detail) · [Milestone brief](../superpowers/plans/2026-08-29-olympus-kairos-tenancy-milestone-brief.md) — K0–K5 then T0–T5; live broker cutover human-gated |
