...
|-------|--------|----------------|--------------|
| Design evolution (Graphite/Cursor/xAI primitives) | done | [#1200](https://github.com/digithings-ai/digithings/issues/1200) epic, #1201–#1231 · [backlog index](design-evolution/INDEX.md) | [`EVOLUTION.md`](../../cloudflare/digiweb/design/EVOLUTION.md) — all phases shipped except the #1212 changelog band (deferred: no releases data source) · extends #235 |
...
| digichat web foundation and bot-profile control plane | in_progress | [#3623](https://github.com/digithings-ai/digithings/issues/3623) (ADR, on develop) · [#3626](https://github.com/digithings-ai/digithings/issues/3626) (**digichat 2.0** assistant-ui; draft only — do not merge until 2.0) | Published package is **1.4.0**. 1.5 = non-UI only. Hold #3565 and other 1.x UI chrome. [ADR-0028](../adr/0028-digichat-web-foundation-and-opencode-distribution.md) |
| OSS web search Phase C/D follow-ups | todo | [#4249](https://github.com/digithings-ai/digithings/issues/4249) C↔D bridge · [#4250](https://github.com/digithings-ai/digithings/issues/4250) turn-backed watches · [#4251](https://github.com/digithings-ai/digithings/issues/4251) spend scoring · [#4252](https://github.com/digithings-ai/digithings/issues/4252) budget anchors | Deferred from the integration review (`docs/superpowers/specs/2026-09-14-oss-websearch-integration-review.md`, on `module/digisearch`) items 5–7 + Phase D §Interfaces. Phases A–D shipped (#4055/#4064/#4065/#4066); hardening chain #4192/#4234/#4165/#4241 merged |
