...
| DigiSkills — agent-skill compiler | in_progress | [#1453](https://github.com/digithings-ai/digithings/issues/1453) epic, #1454 P0 (ADR, done), [#1458](https://github.com/digithings-ai/digithings/issues/1458) P1 (compiler core) | [ADR-0023](../adr/0023-digiskills-agent-skill-compiler.md) |
