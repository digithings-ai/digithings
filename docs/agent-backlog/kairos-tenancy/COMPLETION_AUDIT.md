...
**2026-08-31T22:35Z — [#3345](https://github.com/digithings-ai/digithings/pull/3345) (`012b2accc`) + [#3346](https://github.com/digithings-ai/digithings/pull/3346) (`c2b3770c3`) on `develop`:** remaining `33426508863` Atlas fail-softs. `DocumentPatch.op='add'` maps to `set` (RFC 6902 write verb). `Finding`/`Source` coerce JSON-string Gemini Object envelopes and fill `summary` only from explicit prose aliases (`text`/`detail`/…). Do not stack onto [#3343](https://github.com/digithings-ai/digithings/pull/3343).
