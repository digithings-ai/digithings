...
**Vendor email:** `admin@digithings.ai` (company Google; owner signs in on the desktop). Do not use Agentmail for vendor accounts. See [`DIGITHINGS-IDENTITY.md`](DIGITHINGS-IDENTITY.md).  
