...
| Vendor identity (`admin@digithings.ai` Google) | **Policy** — owner signs into Google on the desktop; agents use Sign in with Google. Agentmail is not used for vendor signup. See [`DIGITHINGS-IDENTITY.md`](DIGITHINGS-IDENTITY.md). | Vendor consoles |
