...
- Repo gates: `make score` (all dimensions), human review (network exposure), `apps/digichat/ARCHITECTURE.md` updated (new sections: embed tenant registry, external relay adapter, revised embed security analysis).
