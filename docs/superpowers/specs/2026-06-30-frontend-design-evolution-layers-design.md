...
**Strategy:** [`packages/design/EVOLUTION.md`](../../../packages/design/EVOLUTION.md)  
**References:** [`packages/design/references/scans/`](../../../packages/design/references/scans/INDEX.md)
...
### Voice guide (→ `packages/design/COPY_GUIDE.md`)
...
|------|------|---------------|
| `packages/design/COPY_GUIDE.md` | New doc | Yes — docs issue |
...
| E8 | `packages/design/COPY_GUIDE.md` | D | P1 | none (docs) |
...
3. ~~Write `packages/design/COPY_GUIDE.md` from §Layer D (E8).~~ Done — see [`COPY_GUIDE.md`](../../../packages/design/COPY_GUIDE.md).
