...
- Modify: Cloudflare container wiring following the existing stack file under `apps/digithings-stack-cloudflare/` (implementer locates the exact wrangler/container config via glob; adds the new service beside the existing ones)
