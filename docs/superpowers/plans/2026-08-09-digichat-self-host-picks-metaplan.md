...
|---|---|---|---|
| Pick 1 | Prefer `module/digichat` if active; else `develop` (frontend one-hop) | `task/<N>-digichat-runtime-csp` | `apps/digichat/**`, `publish-digichat-image.yml`, digichat INSTALL CSP section, profile env **CSP comments only** |
...
- [ ] Read `apps/digichat/AGENTS.md` + `ARCHITECTURE.md` + Next 16 `proxy.md`
