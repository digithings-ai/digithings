...
**Files:**
- Modify: `apps/digithings-stack-cloudflare/src/index.ts`
- Modify: `apps/digithings-stack-cloudflare/container/entrypoint.sh`
- Modify: `apps/digithings-stack-cloudflare/container/seed_chroma.sh`
- Modify: `apps/digithings-stack-cloudflare/container/start_digisearch.sh`
- Modify: `apps/digithings-stack-cloudflare/wrangler.toml`
- Modify: `apps/digithings-stack-cloudflare/README.md`
...
In `apps/digithings-stack-cloudflare/src/index.ts`, add to the `envVars` object literal (alongside the existing `CHROMA_PATH` / `DIGISEARCH_INDEX` entries):
...
```bash
sh -n apps/digithings-stack-cloudflare/container/entrypoint.sh
sh -n apps/digithings-stack-cloudflare/container/seed_chroma.sh
sh -n apps/digithings-stack-cloudflare/container/start_digisearch.sh
```
Expected: no output from any of the three.

Run: `cd apps/digithings-stack-cloudflare && npx tsc --noEmit -p tsconfig.json`
...
```bash
git add apps/digithings-stack-cloudflare/
