...
| `digichat/` | [apps/digichat/AGENTS.md](../../apps/digichat/AGENTS.md) | [apps/digichat/ARCHITECTURE.md](../../apps/digichat/ARCHITECTURE.md) | 3005 (profile) | `npm run test --workspace digichat` |
| `apps/dashboard/` | — | [apps/dashboard/README.md](../../apps/dashboard/README.md) | static export | `cd apps/dashboard && npm run lint && npm run test && npm run build` (not in `make test-unit`; see `test-dashboard.yml`) |
