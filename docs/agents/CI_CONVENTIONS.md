...
| `agent-ci-failure-triage.yml` | Agent: CI failure triage | workflow_run (completed) | Create a `ci:failure` issue when a PR workflow fails; guarded by `DIGITHINGS_PROJECT_TOKEN` | Fixed (#292) | none |
