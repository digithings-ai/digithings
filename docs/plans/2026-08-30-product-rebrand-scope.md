...
> **Date:** 2026-08-30
> **Status:** Accepted — product name is **digiquant** (ADR-0026). On-site CTA is **`open dashboard`**. Wave 1 copy and wave 3 identifiers shipped (#3261). Wave 2 public path is `/dashboard/` (308s from `/olympus/`; no `dist/olympus` twin). Wave 3 folder / npm rename is `frontend/dashboard` (package `dashboard`).
