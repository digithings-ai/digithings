...
Usage:
    packages/brand/build-header.py          # write headers + kit copies
    packages/brand/build-header.py --check   # verify, write nothing
"""
...
PUBLIC_OG_PNG = REPO_ROOT / "apps" / "digithings-web" / "public" / "og.png"
...
def header_svg(og, lay: HeaderLayout) -> str:
  ...
  <!-- GENERATED by packages/brand/build-header.py — do not hand-edit.
