...
**Canonical implementation (ours):** [`../tokens.css`](../tokens.css), [`../site/site.css`](../site/site.css), [`@digithings/ui`](../../ui/)
...
|---------|------|-------------|
| digithings.ai | `apps/digithings-web/` | Marketing + architecture story |
| digiquant.io | `apps/digiquant-web/` | Marketing + quant product proof |
| digichat | `apps/digichat/` | Product-as-landing (terminal chat) |
| dashboard | `apps/dashboard/` | Professional dashboard |
| twelve-x | `apps/dashboard/components/twelve-x/` | Data-dense research utility |
| Shared system | `packages/design/`, `packages/ui/` | Tokens, primitives, motion |
