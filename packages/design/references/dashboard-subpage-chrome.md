...
[`apps/dashboard/components/subpage-tab-bar.tsx`](../../dashboard/components/subpage-tab-bar.tsx).
...
note in `apps/dashboard/app/globals.css` (#1216). dashboard has no `ARCHITECTURE.md`,
