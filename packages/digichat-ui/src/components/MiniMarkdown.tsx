import { ChatMarkdown } from "@digithings/ui";

/**
 * Markdown renderer for streamed model output — a thin delegate to the shared
 * `<ChatMarkdown>` (`@digithings/ui`), which owns the `.chat-md` grammar,
 ...
 *
 * Styling arrives via `@digithings/ui/styles/chat-core.css` plus
