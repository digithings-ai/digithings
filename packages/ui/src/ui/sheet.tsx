  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          // `side` names a PHYSICAL edge in this API, so the data-[side=…]
          // geometry below stays physical (left/right, border-l/r) and does
          // not mirror under dir=rtl. Only the close affordance is logical.
