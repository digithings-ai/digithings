...
import { useSkinChrome } from "./skin-chrome";
import { cn } from "@/lib/utils";

// Protocol literal mirrored from the app's embed-page-context-messages
// (`PAGE_CONTEXT_ATTACHMENT_NAME = "page-context.html"`). The sending side
// names the page-context attachment; silent skins suppress its chip by this
// name. Kept as a literal so the package never imports app code (WS4).
const PAGE_CONTEXT_ATTACHMENT_NAME = "page-context.html";
