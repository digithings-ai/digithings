...
// cloudflare/** is excluded from the score job (the rubrics are Python-oriented
...
const LIMITS: { term: string; body: string }[] = [
  ...
  },
  {
    ...
    body:
      "The score job excludes cloudflare/** entirely: the rubrics are Python-oriented and misfire on " +
