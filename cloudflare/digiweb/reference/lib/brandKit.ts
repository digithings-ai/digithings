 ...
 *
 *  Served copies live under cloudflare/digiweb/reference/public/brand/ and are
 *  kept in sync by `cloudflare/digiweb/brand/build-header.py --check`. Canonical
 *  sources stay in `cloudflare/digiweb/brand/` so a second hand-copied logo
