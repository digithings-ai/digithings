 ...
 *
 * Source: cloudflare/digiquant-web/components/landing/ResearchPipeline.tsx
 * (logic and class names verbatim; the outer section chrome is stripped so the
 * reference page supplies its own kicker/title/copy). Styles for the dqpipe-*
 * classes are copied into app/effects/effects.css from
 * cloudflare/digiquant-web/app/globals.css.
 *
 * Motion: steps slide in from alternating sides via one IntersectionObserver;
 * the centre timeline fills with scroll progress (same accent-bar language as
 * the digiquant hero scroll cue). Reduced motion: steps render in place and
 * the track fill renders full. No JS: html.no-js CSS in effects.css shows the
 * assembled state.
 */
...
export function ResearchPipeline() {
  ...
  return (
    <div className="dqpipe-steps-wrap fx-demo">
