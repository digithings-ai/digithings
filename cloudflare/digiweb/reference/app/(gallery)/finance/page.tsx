...
const CHART_RULES = [
  "Lightweight Charts (TradingView's open-source engine) is the price/series primitive for DASHBOARD surfaces. Print-grade surfaces (PDF-exporting tearsheets) compose the SVG finance-tearsheet family instead — canvas rasterizes in print. The split ruling: cloudflare/digiweb/CHARTS.md.",
