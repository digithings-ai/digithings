...
const FAMILY_RULES = [
  "Print-first pure SVG is the hard constraint: Download PDF flushSync-re-renders the SAME chart instances at full span and calls window.print() — screen and print share one render tree, so canvas engines are disqualified here. Dashboards without a print path use the canvas finance-charts / finance-composites families instead (cloudflare/digiweb/CHARTS.md).",
