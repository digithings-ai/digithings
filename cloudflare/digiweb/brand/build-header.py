...
Usage:
    cloudflare/digiweb/brand/build-header.py          # write headers + kit copies
    cloudflare/digiweb/brand/build-header.py --check   # verify, write nothing
"""
...
PUBLIC_OG_PNG = REPO_ROOT / "cloudflare" / "digithings-web" / "public" / "og.png"
...
def header_svg(og, lay: HeaderLayout) -> str:
  ...
  <!-- GENERATED by cloudflare/digiweb/brand/build-header.py — do not hand-edit.
