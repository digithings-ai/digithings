...
import { DotMatrix, type DotMatrixState } from "../DotMatrix";
import {
...
const statusMatrix: Record<ToolStatus, DotMatrixState> = {
  running: "tool",
  complete: "success",
  incomplete: "error",
  ...
  return (
    <ToolFallbackRoot open={open} onOpenChange={setOpen}>
      <ToolFallbackTrigger
        ...
        completedMs={isErrorStatus ? undefined : durationFromResult(result)}
      />
      <ToolFallbackContent>
