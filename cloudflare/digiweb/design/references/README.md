...
**The design mine (extracted specimens + convergence blends, static page):** [`mine/index.html`](mine/index.html) — serve `cloudflare/digiweb/design/` and open `/references/mine/index.html`
...
|---------|------|-------------|
| digithings.ai | `cloudflare/digithings-web/` | Marketing + architecture story |
| digiquant.io | `cloudflare/digiquant-web/` | Marketing + quant product proof |
| digichat | `cloudflare/digichat/` | Product-as-landing (terminal chat) |
| dashboard | `cloudflare/dashboard/` | Professional dashboard |
| twelve-x | `cloudflare/dashboard/components/twelve-x/` | Data-dense research utility |
| Shared system | `cloudflare/digiweb/design/`, `cloudflare/digiweb/web/` | Tokens, primitives, motion |

Legacy static sites (`cloudflare/digithings/`, `cloudflare/digiquant/`) are not
