...
|---------|------|----------------------------------|
| design-reference | `cloudflare/digiweb/reference/` | **Phase 0 — now** |
| `@digithings/design` tokens | `cloudflare/digiweb/design/tokens.css` | **Phase 0 — now** |
| `@digithings/web` shared sheets | `cloudflare/digiweb/web/src/styles/` | Phase 1 |
| digithings.ai | `cloudflare/digithings-web/` | **Phase 2 — this branch** |
| digiquant.io | `cloudflare/digiquant-web/` | **Phase 2 — this branch** |
| digichat | `cloudflare/digichat/` | Phase 3 |
| dashboard + FX Hub (twelve-x) | `cloudflare/dashboard/` | Phase 3 |
