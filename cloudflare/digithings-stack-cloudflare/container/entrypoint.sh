...
export DIGI_ALLOWED_TOOLS="${DIGI_ALLOWED_TOOLS:-digisearch,digivault_search_notes,digivault_get_note,zammad_search_tickets,zammad_get_ticket,zammad_ticket_report}"
