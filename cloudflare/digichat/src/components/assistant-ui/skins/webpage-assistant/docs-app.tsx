...
export function DocsApp({ previewWarning }: { previewWarning?: string }) {
  ...
  return (
    <div className="h-full overflow-hidden bg-[color-mix(in_oklab,var(--docs-accent)_4%,#f7f8fb)] text-foreground">
      {previewWarning ? (
      ...
      <main
        className={`grid h-[calc(100%-3.5rem)] grid-cols-1 overflow-hidden ${
